...
export class Sprite {
    ...
    constructor(ctx, image, sx = 0, sy = 0, sw, sh, dx, dy, width, height) {
        ...
        this.size = Vec2.create(width || this.image.width, height || this.image.height);
        this.rotation = 0;
        this.flipX = false;
        this.flipY = false;
    }
    render() {
        ...
        this.ctx.translate(-(this.position.x + this.size.x / 2), -(this.position.y + this.size.x / 2));
        this.ctx.drawImage(this.image, this.sourceX, this.sourceY, this.sourceWidth, this.sourceHeight, this.position.x, this.position.y, this.size.x, this.size.y);
        this.ctx.restore();
    }
}
export class AnimatedSprite {
    ...
    constructor(ctx, spritesheet, numCol, numRow, x, y, width, height) {
        ...
        this.size = Vec2.create(width || this.frameWidth, height || this.frameHeight);
    ...
    render() {
        ...
        this.ctx.scale(this.flipX ? -1 : 1, this.flipY ? -1 : 1);
        this.ctx.translate(-(this.position.x + this.size.x / 2), -(this.position.y + this.size.x / 2));
        this.ctx.drawImage(this.spritesheet, col * this.frameWidth, row * this.frameHeight, this.frameWidth, this.frameHeight, this.position.x, this.position.y, this.size.x, this.size.y);
        this.ctx.restore();
    }
}
